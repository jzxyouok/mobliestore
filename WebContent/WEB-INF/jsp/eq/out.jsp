...
<body>
    ...
    <div class="enter">
    <form action="destory.html" method="post">
    	<table>
    	<strong>器材如有损坏先执行归还操作再进入本页面出库</strong>
...
<c:forEach items="${typelist }" var="l"><c:if test="${l.fid eq 0 }">     	
        	...
        	<tr><td align="right" class="enter_left">数量：</td><td align="left" colspan="3"><input name="num" type="text"/>不得大于库存数量</td></tr>
